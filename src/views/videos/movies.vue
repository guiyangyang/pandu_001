                ...
                <el-col :span="6" v-for="(book,index) in bookLists" :key="index" >
                    <div class="book-col">
                        <div class="div-img">
                            ...
                            <div v-else class="text-box" ><span>movie</span></div>
                        </div>
...
export default {
    ...
    data () {
        return {
            ...
            typeList:[
                {'value':'all','title':'全 部'},
                {'value':'movies','title':'电 影'},
                {'value':'teleplay','title':'电视剧'},
                {'value':'ITvideo','title':'IT视频'},
                {'value':'interest','title':'兴趣视频'},
